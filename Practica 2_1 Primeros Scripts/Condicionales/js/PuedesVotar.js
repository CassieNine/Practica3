...
<head>
	<meta charset="utf-8">
	<title>Condicional Simple: Se puede o no votar</title>
	...
	<div class="container">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<li><a class="dropdown-item" href="../ciclos/sumatoriaWhile.html">Sumatoria 100 while</a>
								</li>
								...
								<li><a class="dropdown-item" href="../ciclos/sumatoriaDo.html">Sumatoria 100 do-while</a>
								</li>
							</ul>
						</li>
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<li><a class="dropdown-item" href="../operacionesBase/numMayorArreglo.html">Número Mayor
										en Arreglo</a></li>
								<li><a class="dropdown-item" href="../operacionesBase/sumaArreglos.html">Suma de Arreglos
										A y B en C</a></li>
		...
		<div>
			<section>
				<article>
					<hr>
					<h2>Condicional Simple: Se puede o no votar</h2>
					<hr>
				</article>
				<article>
					<hr>
