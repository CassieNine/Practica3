...
<head>
	<meta charset="utf-8">
	<title>Condicional Múltiple: Ejemplo Switch</title>
	...
	<div class="container">
		...
		<div>
			<section>
				<article>
					<hr>
					<h2>Condicional Múltiple: Ejemplo Switch</h2>
					<hr>
				</article>
				<article>
					<hr>
					<script type="text/javascript">
						var dato1 = '';
						dato1 = prompt('Ingrese su nombre, por favor: ');
						switch (dato1.toUpperCase()) {
							case 'EMILIANO': document.write('Hola ' + dato1);
								break;
							case 'ALEJANDRO': document.write('Hola ' + dato1);
								break;
							case 'JOSE': document.write('Hola ' + dato1);
								break;
							default: document.write('No se encuentra entre los parámetros ' + dato1);
								break;
						}
					</script>
				</article>
