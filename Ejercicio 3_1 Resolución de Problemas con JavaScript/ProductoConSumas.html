...
<head>
	<meta charset="utf-8">
	<title>Operaciones Base: Producto de 2 números mediante sumas</title>
	...
	<div class="container">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<li><a class="dropdown-item" href="../condicionales/mayor3nums.html">Mayor de 3
										números</a></li>
		...
		<div>
			<section>
				<article>
					<hr>
					<h2>Operaciones Base: Producto de 2 números mediante sumas</h2>
					<hr>
				</article>
				<article>
					<hr>
					<script type="text/javascript">
						...
						var num2 = prompt("Introduzca otro número entero: ");
						var res = 0;
						num = parseInt(num);
						for (var i = 0; i < num2; i++) {
							res += num;
						}
						document.write("El producto de " + num + " por " + num2 + " es " + res);
					</script>
				</article>
			</section>
		</div>
