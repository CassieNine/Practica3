...
<head>
	<meta charset="utf-8">
	<title>Operaciones Base: Media Aritmética</title>
	...
	<div class="container">
		...
		<div>
			<section>
				<article>
					<hr>
					<h2>Operaciones Base: Media Aritmética</h2>
					<hr>
				</article>
				<article>
					<hr>
					<script type="text/javascript">
						...
						document.write("<p>Secuencia de números: " + "[" + A + "]" + "</p>");
						mediaArit(A, n);

						function mediaArit(A, n) {
							var count = 0;
							for (var i = 0; i < n; i++) {
								count += A[i];
							}
							document.write("<p>La media aritmética de la secuencia de números es: " + count/n + "</p>");
						}
