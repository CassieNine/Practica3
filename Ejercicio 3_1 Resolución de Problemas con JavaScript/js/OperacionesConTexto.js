...
<head>
	<meta charset="utf-8">
	<title>Operaciones Base: Operaciones con texto</title>
	...
	<div class="container">
		...
		<div>
			<section>
				<article>
					<hr>
					<h2>Operaciones Base: Operaciones con texto</h2>
					<hr>
				</article>
				<article>
					<hr>
					<script type="text/javascript">
						cadena = prompt("Ingrese una cadena de texto, por favor: ")
						document.write("<p>Longitud: " + cadena.length + "</p>");
						document.write("<p>Minusculas: " + cadena.toLowerCase() + "</p>");
						document.write("<p>Mayusculas: " + cadena.toUpperCase() + "</p>");
					</script>
				</article>
			</section>
		</div>
